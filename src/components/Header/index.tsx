    ...
    <>
      ...
      <header className="header_desktop" style={{background: 'white'}}>
        ...
        <div style={{display: "flex"}}>
          ...
          <p>
            <Link className="header__link_desktop" style={{fontSize: 18, color: "black", cursor: "pointer", marginRight: 20}} to="/hemsidapro">Hemsida Pro</Link>
          </p>
          <p>
            <Link className="header__link_desktop" style={{fontSize: 18, color: "black", cursor: "pointer"}} to="#faq">FAQ</Link>
          </p>
          <p>
          <Link className="header__link_desktop" style={{fontSize: 18, color: "black", cursor: "pointer", marginLeft: 20}} to="/support">Support</Link>
          </p>
        </div>
      </header>
    </>
